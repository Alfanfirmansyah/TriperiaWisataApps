...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li><a href="javascript:void(0);" class="waves-effect waves-block waves-light translation-button"  data-activates="translation-dropdown"><img src="/demo/images/flag-icons/United-States.png" alt="USA" /></a>
                        </li>
                    ...
                    <div id="card-widgets">
                        <div class="row">
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    ...
                                    <div class="card-content">
                                        <img src="/demo/images/avatar.jpg" alt="" class="circle responsive-img activator card-profile-image">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l4">
                                ...
                                <div class="card">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img src="/demo/images/gallary/30.jpg" alt="blog-img">
                                    </div>
                                ...
                                <div class="product-card">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            ...
                                            <img src="/demo/images/gallary/33.jpg" alt="product-img">
                                        </div>
                                        <ul class="card-action-buttons">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col s4 no-padding">
                                                    <a href=""></a><img src="/demo/images/amazon.jpg" alt="amazon" class="responsive-img">
                        ...
                        <li>
                            ...
                            <div class="collapsible-body favorite-associates">
                                <div class="favorite-associate-list chat-out-list row">
                                    <div class="col s4"><img src="/demo/images/avatar.jpg" alt="" class="circle responsive-img online-user valign profile-image">
                                    </div>
                                    <div class="col s8">
                                        <p>Eileen Sideways</p>
                                ...
                                <div class="favorite-associate-list chat-out-list row">
                                    <div class="col s4"><img src="/demo/images/avatar.jpg" alt="" class="circle responsive-img offline-user valign profile-image">
                                    </div>
                                    <div class="col s8">
                                        <p>Renov Leongal</p>
    ...
    <!--google map-->
    <script type="text/javascript" src="{{asset('demo/js/plugins/google-map/google-map-script.js')}}"></script>
